...
export default function TabOneScreen() {
  ...
  const updateProfile = async () => {
    ...
    try {
      ...
      const response = await axios.post(`http://lms.knowledgequran.info/companyadmin/profile_app/update/${user.user_id}`, formData, {
        headers: {
  ...
  const updatePassword = async () => {
    ...
    try {
      ...
      const response = await axios.post(`http://lms.knowledgequran.info/companyadmin/profile_app/password/${user.user_id}`, formData, {
        headers: {
          "Content-Type": "multipart/form-data",
        },
      });
  ...
  const GetInfo = async () => {
    try {
      const response = await axios.get(`http://lms.knowledgequran.info/companyadmin/profile_app/${user.user_id}`);
